...
#                                                                              
#  Desc:  Prepare the LVM components of the IBM Spectrum Protect blueprint storage on AIX.      
#                                                                              
...
sub getlogHeader 
{
  ...
  $line =
"********************************************************************************\n";
  my $longtestcase = "**  IBM Spectrum Protect storage preparation script ($platform) log\n";
  my $date         =
